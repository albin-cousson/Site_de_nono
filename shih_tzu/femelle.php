...
<html lang="fr">
  <head>
    <title>Élevage de Saint Prixe - Shih-tzu femelle </title>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12 p-0">
          <?php 
            $header = $bdd->query("SELECT * FROM shihTzuFemelle_header");
      ...
      <div class="row mt-3 mb-3 ml-1 mr-1">
        <?php
          $blockPresentation = $bdd->query("SELECT nom FROM shihTzuFemelle_nomDuChien");
          ...
          <div class="card card__block m-3 text-center">
            ...
            <div id="<?php echo $blockPresentation_recu['nom']; ?>" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                <?php
                  $blockPresentation_firstImageSlider = $bdd->prepare("SELECT shihTzuFemelle_blockPresentaionSlider.images FROM shihTzuFemelle_blockPresentaionSlider, shihTzuFemelle_nomDuChien WHERE shihTzuFemelle_blockPresentaionSlider.id_nomDuChien=shihTzuFemelle_nomDuChien.id AND shihTzuFemelle_nomDuChien.nom=? AND shihTzuFemelle_blockPresentaionSlider.position=1");
                ...
                ?>
                <?php
                  $blockPresentation_slider = $bdd->prepare("SELECT shihTzuFemelle_blockPresentaionSlider.images FROM shihTzuFemelle_blockPresentaionSlider, shihTzuFemelle_nomDuChien WHERE shihTzuFemelle_blockPresentaionSlider.id_nomDuChien=shihTzuFemelle_nomDuChien.id AND shihTzuFemelle_nomDuChien.nom=? AND shihTzuFemelle_blockPresentaionSlider.position!=1");
            ...
            <div class="tab-content" id="pills-tabContent">
              <div class="tab-pane fade show active" id="profile_<?php echo $blockPresentation_recu['nom']; ?>" role="tabpanel" aria-labelledby="pills-home-tab">
                <?php
                  $blockPresentation_profile = $bdd->prepare("SELECT * FROM shihTzuFemelle_blockPresentaionProfile, shihTzuFemelle_nomDuChien WHERE shihTzuFemelle_blockPresentaionProfile.id_nomDuChien=shihTzuFemelle_nomDuChien.id AND shihTzuFemelle_nomDuChien.nom=?");
              ...
              <div class="tab-pane fade" id="resultat_<?php echo $blockPresentation_recu['nom']; ?>" role="tabpanel" aria-labelledby="pills-profile-tab">
                <div class="card" style="width: 100%;">
                  ...
                  <?php
                    $blockPresentation_resultat = $bdd->prepare("SELECT * FROM shihTzuFemelle_blockPresentaionResultat, shihTzuFemelle_nomDuChien WHERE shihTzuFemelle_blockPresentaionResultat.id_nomDuChien=shihTzuFemelle_nomDuChien.id AND shihTzuFemelle_nomDuChien.nom=?");
