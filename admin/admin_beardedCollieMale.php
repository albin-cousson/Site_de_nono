                        ...
                        <table class="w-100">
                          <caption class="position-relative">
                            ...
                            <nav class="navbar p-0">
                              ...
                              <a class="btn btn-outline-light position-relative" href="crud/ajout_carousel_header.php?page=../admin_beardedCollieMale.php&table=beardedCollieMale_blockPresentaionSlider&foreignKey=true">Ajouter</a>
                            </nav>
                          </caption>
                          <?php
                              ?>
                            ...
                            while($entres_recu = $entres->fetch()){
                              ?>
                                <tr>
                                  ...
                                  <td>
                                    <a class="btn btn-outline-success" href="crud/modification_carousel_header.php?page=../admin_beardedCollieMale.php&table=beardedCollieMale_blockPresentaionSlider&id=<?php echo $entres_recu['id'] ?>&foreignKey=true">Modifier</a>
                                  </td>
                                  <td>
                        ...
                        <table class="w-100">
                          <caption class="position-relative">
                            ...
                            <nav class="navbar p-0">
                              ...
                              <a class="btn btn-outline-light position-relative" href="crud/ajout_carousel_header.php?page=../admin_beardedCollieMale.php&table=beardedCollieMale_blockPresentaionResultat&foreignKey=true">Ajouter</a>
                            </nav>
                          </caption>
                          <?php
                              ?>
                            ...
                            while($entres_recu = $entres->fetch()){
                              ?>
                                <tr>
                                  ...
                                  <td>
                                    <a class="btn btn-outline-success" href="crud/modification_carousel_header.php?page=../admin_beardedCollieMale.php&table=beardedCollieMale_blockPresentaionResultat&id=<?php echo $entres_recu['id'] ?>&foreignKey=true">Modifier</a>
                                  </td>
                                  <td>
