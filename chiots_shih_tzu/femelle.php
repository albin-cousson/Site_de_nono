...
<html lang="fr">
  <head>
    <title>Élevage de Saint Prixe - Chiots shih-tzu femelle </title>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12 p-0">
          <?php 
            $header = $bdd->query("SELECT * FROM chiots_shihTzuFemelle_header");
      ...
      <div class="row mt-3 mb-3 ml-1 mr-1">
        <?php
          $blockPresentation = $bdd->query("SELECT nom FROM chiots_shihTzuFemelle_nomDuChien");
          ...
          <div class="card card__block m-3 text-center">
            ...
            <div id="<?php echo $blockPresentation_recu['nom']; ?>" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                <?php
                  $blockPresentation_firstImageSlider = $bdd->prepare("SELECT chiots_shihTzuFemelle_blockPresentaionSlider.images FROM chiots_shihTzuFemelle_blockPresentaionSlider, chiots_shihTzuFemelle_nomDuChien WHERE chiots_shihTzuFemelle_blockPresentaionSlider.id_nomDuChien=chiots_shihTzuFemelle_nomDuChien.id AND chiots_shihTzuFemelle_nomDuChien.nom=? AND chiots_shihTzuFemelle_blockPresentaionSlider.position=1");
                ...
                ?>
                <?php
                  $blockPresentation_slider = $bdd->prepare("SELECT chiots_shihTzuFemelle_blockPresentaionSlider.images FROM chiots_shihTzuFemelle_blockPresentaionSlider, chiots_shihTzuFemelle_nomDuChien WHERE chiots_shihTzuFemelle_blockPresentaionSlider.id_nomDuChien=chiots_shihTzuFemelle_nomDuChien.id AND chiots_shihTzuFemelle_nomDuChien.nom=? AND chiots_shihTzuFemelle_blockPresentaionSlider.position!=1");
            ...
            <div class="tab-content" id="pills-tabContent">
              <div class="tab-pane fade show active" id="profile_<?php echo $blockPresentation_recu['nom']; ?>" role="tabpanel" aria-labelledby="pills-home-tab">
                <?php
                  $blockPresentation_profile = $bdd->prepare("SELECT * FROM chiots_shihTzuFemelle_blockPresentaionProfile, chiots_shihTzuFemelle_nomDuChien WHERE chiots_shihTzuFemelle_blockPresentaionProfile.id_nomDuChien=chiots_shihTzuFemelle_nomDuChien.id AND chiots_shihTzuFemelle_nomDuChien.nom=?");
            ...
            <div class="card-footer border-top border-primary">
                <?php
                  $blockPresentation_prix = $bdd->prepare("SELECT prix FROM chiots_shihTzuFemelle_prix, chiots_shihTzuFemelle_nomDuChien WHERE chiots_shihTzuFemelle_prix.id_nomDuChien=chiots_shihTzuFemelle_nomDuChien.id AND chiots_shihTzuFemelle_nomDuChien.nom=?");
